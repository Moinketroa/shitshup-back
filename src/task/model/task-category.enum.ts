export enum TaskCategory {
    ...
    SUB6_UPLOAD_TRACKS_TO_DROPBOX = 'UPLOAD TRACKS TO DROPBOX',
    SUB6_CREATE_SHARING_LINKS = 'CREATE DROPBOX SHARED LINKS',
    SUB6_LINK_TRACKS_TO_NOTION = 'LINK TRACKS TO NOTION',

    STEP7 = 'STEP 7',

    SUB7_GET_SPLEETER_DATA = 'PREDICT STEMS FROM SPLEETER',
}
